...
self.addEventListener('message', function (e) {
    ...
    if (packer === 'evalencode') {
        ...
        try {
            self.importScripts('https://cdn.statically.io/gh/rooplal/web_tools/master/aadecode.min.js');
        ...
        try {
            self.importScripts('https://cdn.statically.io/gh/rooplal/web_tools/master/jjdecode.min.js');
        ...
        try {
            self.importScripts('https://cdn.statically.io/gh/rooplal/web_tools/master/urlencode_unpacker.min.js');
        ...
        try {
            self.importScripts('https://cdn.statically.io/gh/rooplal/web_tools/master/p_a_c_k_e_r_unpacker.min.js');
        ...
        try {
            self.importScripts('https://cdn.statically.io/gh/rooplal/web_tools/master/javascriptobfuscator_unpacker.min.js');
        ...
        try {
            self.importScripts('https://cdn.statically.io/gh/rooplal/web_tools/master/myobfuscate_unpacker.min.js');
